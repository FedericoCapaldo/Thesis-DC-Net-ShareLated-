...
\bibitem{Wang} Y. Wang, P. Dasgupta, "Anonymous communication on the internet", \url{https://pdfs.semanticscholar.org/1916/1a4aad8e88da9d05a2a8d731e5f75502172b.pdf}

\bibname{Ascii} ProgramBL, "ASCII Table - Standard and Extended ASCII Table", \url{http://dochome.programbl.com/rs232-cps-plus/tools-ascii-table-standard-and-extended-ascii-table.html}
...
% \inputminted[breaklines]{javascript}{Appendices/package.json}
